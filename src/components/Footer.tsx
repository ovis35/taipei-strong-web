        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-6">
              ...
              <span className="font-bold text-2xl">CHILI GYM</span>
            </div>
            <p className="text-gray-400 mb-6">
              栖里健身俱樂部 - 運動，是一種更完整的生活。近千坪寬敞空間，為您打造高品質的健身體驗。
            </p>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/Chiligymclub" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gym-red" aria-label="Facebook">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"></path>
                </svg>
              </a>
              <a href="https://www.instagram.com/chiligym_/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gym-red" aria-label="Instagram">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <address className="not-italic text-gray-400 space-y-3">
              <p>台北市北投區公館路427號B1, 1F, Taipei, Taiwan 112</p>
              <p>電話: 02 2823 496</p>
              <p>Email: chiligymclub@gmail.com</p>
            </address>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} CHILI GYM | 栖里健身俱樂部。保留所有權利。
            </p>
